...
Gradle automatically manages JavaFX dependencies.
...
Draws circuit components onto the workspace.

**Implemented Features:**

- Render NMOS transistors
- Render PMOS transistors
- Render input nodes
- Render power nodes
- Render ground nodes
...
ComponentRenderer converts component world positions into screen positions using the Camera.

Components do not know how they are drawn.
Rendering is handled separately from circuit logic.
...
Contains systems responsible for editor interaction.

The active tool determines how mouse and keyboard input behaves.
...
Controls the currently active editor tool.
...
Places new components into the circuit.

**Implemented Features:**

- Converts mouse position into world coordinates
- Creates components using ComponentFactory
- Adds components to the Circuit
- Redraws the workspace

**Design:**

Placement is separated from specific component types.

The tool does not know how to create NMOS, PMOS, or other components.
It receives a ComponentFactory instead.
