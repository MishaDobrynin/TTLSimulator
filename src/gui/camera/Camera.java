...
public class Camera {
    /**
     * this class is an abstraction of the camera
     * it will not be doing any panning
     * simply coordinate processing (is the plan)
     * and information storage
     */
    private Vector2 center;
    private double zoom;
    public static final double DEFAULT_ZOOM = 1.0; //zooming default
    public Camera(){
     ...
     * into camera-relative coordinates
     */
